  ...
  describe("Interrupt 2ds a wk", () => {
    ...
    describe("Sun", () => {
      ...
      it("Second after 1st Fri repeat", (done) => {
        ...
        assert.isTrue(moment.isMoment(actual));
        assert.isTrue(ND_MONDAY.isSame(actual));
        done();
      ...
      it("Second after 2nd Mon repeat", (done) => {
        ...
        assert.isTrue(moment.isMoment(actual));
        assert.isTrue(ND_FRIDAY.isSame(actual));
        done();
    ...
    }); // end of Interrupt 2ds a wk.FRI
  }); // end of Interrupt 2ds a wk
});
